...
public class DependencyGraphBuilder<Provider: DependencyProviding, Value: NodeValue> where Value == Provider.Value {
	/// The graph the builder will operate on
	public typealias Graph = DependencyGraph<Value>
	...
	public init(provider: Provider, values: [Value]) {
